    ...
    <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Sign in here.</h2>
                    <h3 class="section-subheading text-muted">Log in to your account to access this section.</h3>
                </div>
            </div>
   <div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <a href="projects.php">Sign Up Here...</a>
            </div>
